...
const categories = [
  {
    ...
    description:
      "Set up your account, deploy your first rule, and go live in under 5 minutes.",
    href: "#",
    articles: 12,
  },
  {
    ...
    description:
      "REST endpoints, webhooks, and official SDKs for Node.js, Python, Go, and Ruby.",
    href: "#",
    articles: 34,
  },
  {
    ...
    title: "Billing & Plans",
    description:
      "Manage subscriptions, download invoices, and compare pricing tiers.",
    href: "#",
    articles: 8,
  },
  {
    ...
    title: "Bot Detection",
    description:
      "Configure rules, review analytics, and fine-tune threat thresholds.",
    href: "/bot-detection",
    articles: 21,
  },
  {
    ...
    description:
      "Step-by-step walkthroughs for integrations, migrations, and best practices.",
    href: "#",
    articles: 16,
  },
  {
    ...
    description:
      "Team management, API keys, 2FA setup, SSO configuration, and audit logs.",
    href: "#",
    articles: 10,
  },
]
