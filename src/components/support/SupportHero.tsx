...
export function SupportHero() {
  ...
  return (
    <section className="relative pt-24 pb-12 md:pt-36 md:pb-16 overflow-hidden">
      ...
      {/* Orbs */}
      <div className="absolute -top-24 left-1/4 w-72 h-72 rounded-full bg-blue-100/30 blur-3xl pointer-events-none animate-pulse-slow" />
      <div className="absolute top-20 right-0 w-64 h-64 rounded-full bg-slate-200/30 blur-3xl pointer-events-none animate-pulse-slow delay-500" />
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="flex justify-center mb-8 animate-in fade-in slide-in-from-top-4 duration-700 fill-mode-both">
          <div className="inline-flex items-center gap-2 border border-slate-200 rounded-full bg-white/80 px-4 py-1.5 shadow-sm">
            ...
            <span className="text-sm text-slate-600">24/7 priority support now available</span>
          </div>
        </div>
        ...
        <div className="text-center max-w-4xl mx-auto">
          <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight text-slate-900 text-balance animate-in fade-in slide-in-from-bottom-6 duration-700 delay-150 fill-mode-both">
            How can we{" "}
            <span className="text-gradient-blue">help?</span>
          </h1>
          <p className="mt-6 text-lg md:text-xl text-slate-400 leading-relaxed max-w-2xl mx-auto text-pretty animate-in fade-in duration-700 delay-300 fill-mode-both">
            Search our knowledge base, explore guides, or get in touch with our team. We are here to help.
          </p>
        </div>
        ...
        <div className="mt-10 max-w-xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-700 delay-400 fill-mode-both">
          <div className="relative group">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-4 rounded-xl border border-slate-200 bg-white/80 text-base text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-slate-900 focus:border-transparent transition-all shadow-sm hover:shadow-md focus:shadow-md backdrop-blur-sm"
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-3 animate-in fade-in duration-1000 delay-600 fill-mode-both">
          ...
          {quickLinks.map((link) => (
            <Link
              key={link.label}
              href={link.href}
              className="inline-flex items-center gap-1 text-sm text-slate-600 hover:text-slate-900 bg-white/80 border border-slate-200 rounded-full px-3.5 py-1.5 hover:border-slate-300 hover:shadow-sm transition-all"
            >
              {link.label}
