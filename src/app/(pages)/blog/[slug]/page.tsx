    ...
    <div className="bg-[#020812] min-h-screen">
      ...
      <section className="relative z-10 border-b border-gray-800 pt-24 pb-12 md:pt-32">
        <div className="max-w-5xl mx-auto px-6">
          <Link
            href="/blog"
            className="inline-flex items-center gap-2 text-sm text-gray-500 hover:text-green-400 transition-colors mb-8 font-mono group"
          >
      ...
      <section className="relative z-10 max-w-5xl mx-auto px-6 py-14">
        <div className="grid gap-10 lg:grid-cols-[minmax(0,1fr)_260px]">
          ...
          <article>
            {post.body ? (
              <RichText value={post.body as TypedObject[]} />
            ) : (
          ...
          <aside className="space-y-5">
            <div className="rounded-xl border border-gray-800 bg-gray-900/60 p-5">
              <p className="text-xs uppercase tracking-[0.2em] text-green-500 font-mono mb-4">
                // Key takeaways
              </p>
            ...
            <div className="rounded-xl border border-gray-800 bg-gray-900/60 p-5">
              <p className="text-xs uppercase tracking-[0.2em] text-green-500 font-mono mb-3">
                // Subscribe
              </p>
              <p className="text-sm text-gray-500 mb-4">
                Get monthly research updates on bot defence.
              </p>
          ...
          <div className="border-t border-gray-800 pt-10">
            <div className="flex items-center justify-between mb-6">
              ...
              <Button
                asChild
                variant="ghost"
                className="text-gray-500 hover:text-green-400 font-mono text-sm"
              >
            ...
            <div className="grid gap-4 md:grid-cols-2">
              {related.map((item) => {
                ...
                return (
                  ...
                  >
                    <p className="text-xs uppercase tracking-[0.2em] text-green-500 font-mono">
                      {item.category}
                    </p>
                    <h3 className="mt-3 text-base font-semibold text-white hover:text-green-400 transition-colors">
                      {item.title}
                    </h3>
                    <p className="mt-2 text-xs text-gray-600 font-mono">
                      {relDate} · {item.readTime}
                    </p>
                  </Link>
                );
              })}
